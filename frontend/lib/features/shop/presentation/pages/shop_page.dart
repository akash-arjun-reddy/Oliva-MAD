      ...
      setState(() {
        products = [
          Product(
            ...
            price: '₹550',
            description: 'A gentle cleanser for all skin types. Removes dirt and oil without drying.',
            rating: 5.0,
            reviewCount: 12,
          ),
          Product(
            ...
            price: '₹550',
            description: 'Brightens and revitalizes dull skin. Use daily for best results.',
            rating: 5.0,
            reviewCount: 8,
          ),
          Product(
          ...
          Product(
            ...
            imageAsset: 'assets/images/anti_age.png',
            price: '₹850',
            description: 'Advanced anti-aging treatment for mature skin.',
            rating: 4.8,
            reviewCount: 23,
          ),
          Product(
            name: 'Acne Fade Solution',
            imageAsset: 'assets/images/acnefade_10.png',
            price: '₹650',
            description: 'Effective solution for acne and blemish treatment.',
            rating: 4.7,
            reviewCount: 18,
          ),
          Product(
            ...
            price: '₹750',
            description: 'Targeted treatment for blemishes and dark spots.',
            rating: 4.9,
            reviewCount: 31,
          ),
        ];
