...
class _ShopPageState extends State<ShopPage> {
  ...
  // 3. Use Product model and add mock description, rating, reviewCount
  final List<Product> products = [
    Product(
      name: 'Gentle Face Cleanser 80ml',
      imageAsset: 'assets/images/gentle_face_cleanser.png',
      price: '₹550',
      description:
          'A gentle cleanser for all skin types. Removes dirt and oil without drying.',
      rating: 5.0,
      reviewCount: 12,
    ),
    Product(
      name: 'Skin Radiance Essence...',
      imageAsset: 'assets/images/skin_radiance_essence.png',
      price: '₹550',
      description:
          'Brightens and revitalizes dull skin. Use daily for best results.',
      rating: 5.0,
      reviewCount: 8,
    ),
    Product(
      name: 'Skin Essential Kit',
      imageAsset: 'assets/images/skin_essential_kit.png',
      price: '₹550',
      description: 'Complete kit for your daily skincare routine.',
      rating: 5.0,
      reviewCount: 15,
    ),
    Product(
      name: 'dermOliv Replenishing Body...',
      imageAsset: 'assets/images/dermoliv_replenishing.png',
      price: '₹550',
    ...
    Product(
      name: 'Oliva Sunscreen Lotion - Normal Skin',
      imageAsset: 'assets/images/oliva_ss_normalskin.png',
      price: '₹695',
    ...
    Product(
      name: 'Oliva Sunscreen Dry Touch Cream',
      imageAsset: 'assets/images/oliva_ss_dry_touch.png',
      price: '₹750',
      description: 'Non-greasy sunscreen for dry skin.',
      rating: 4.9,
      reviewCount: 9,
    ),
    Product(
      name: 'Oliva Replinishing Moisturising Gel',
      imageAsset: 'assets/images/oliva_rep_moist_gel.png',
      price: '₹495',
      description: 'Hydrates and soothes your skin instantly.',
      rating: 5.0,
      reviewCount: 11,
    ),
    Product(
      name: 'Oliva Hydrating Cream - Dry',
      imageAsset: 'assets/images/oliva_hyd_cream.png',
      price: '₹535',
      description: 'Rich cream for deep hydration of dry skin.',
      rating: 4.7,
      reviewCount: 6,
    ),
    Product(
      name: 'Azebrite Blemish Free Cream',
      imageAsset: 'assets/images/azebrite_blemish.png',
      price: '₹765',
      description: 'Reduces blemishes and evens skin tone.',
      rating: 4.9,
      reviewCount: 13,
    ),
    Product(
      name: 'AcneFade 10',
      imageAsset: 'assets/images/acnefade_10.png',
      price: '₹175',
      description: 'Targets acne and prevents breakouts.',
      rating: 4.8,
      reviewCount: 14,
    ),
  ];
