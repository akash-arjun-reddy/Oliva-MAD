...
class IndiaMapSearchPageRefactored extends StatefulWidget {
  final String? initialQuery;
  
  const IndiaMapSearchPageRefactored({Key? key, this.initialQuery}) : super(key: key);

  @override
  State<IndiaMapSearchPageRefactored> createState() => _IndiaMapSearchPageRefactoredState();
}

class _IndiaMapSearchPageRefactoredState extends State<IndiaMapSearchPageRefactored> {
  final TextEditingController _searchController = TextEditingController();
  LatLng _mapCenter = const LatLng(22.5937, 78.9629); // Center of India
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('India Map Search')),
      body: Padding(
